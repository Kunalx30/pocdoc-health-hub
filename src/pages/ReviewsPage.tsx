...
const reviews = [
  {
    ...
    comment: 'Dr. Johnson was extremely thorough in her examination and took the time to explain everything clearly. She answered all my questions and made me feel very comfortable. I would highly recommend her to anyone looking for a cardiologist.',
    helpful: 24,
    replies: 2,
  },
  {
    ...
    comment: 'Dr. Johnson has a very caring approach. She spends time with patients and explains things well. The only downside is that the wait time was longer than expected.',
    helpful: 12,
    replies: 1,
  },
  {
    ...
    comment: 'Dr. Chen is the best family doctor we\'ve ever had. He really cares about his patients and takes the time to get to know them. He\'s great with our kids and always provides thoughtful advice.',
    helpful: 18,
    replies: 0,
  }
];
